# B_pulling_already_located_users-SENTIMENT-MACHINE02.R
...
# DATA OUT: ../data/out/already_located_machine02.csv
# NL, 28 June 19
...
write.csv(already_located_users_df, paste0(DATA_OUT, "sentiment_rework_already_located_M02.csv"))
